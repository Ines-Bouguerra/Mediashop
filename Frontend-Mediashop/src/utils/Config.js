class Config {
  ...
  static postApiURL = "http://localhost:8080/api/post/";
  static postDetailApiURL = "http://localhost:8080/api/post/<int:pk>/";
  ...
  static subCategoryApiURL =
    "http://127.0.0.1:8080/api/categories/subcategory-list";
  static adminContactApiURL = "http://localhost:8080/api/contact";
  static adminProductApiURL = "http://localhost:8080/api/admin/product/";
  static adminProductDetailApiURL =
    "http://localhost:8080/api/admin/product/<int:pk>";
