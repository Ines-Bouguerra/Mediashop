                        ...
                        <div className="row">
                            <div className="col-lg-10 offset-lg-1">
                                <div className="contact_form_container">
                                    ...
                                    <form className="form" id="contact_form" onSubmit={this.formSubmit}>
                                        ...
                                        <div className="contact_form_button">
                                            <MDBBtn type='submit' rounded className='mx-2  mb-2 m-5' color='primary' disabled={this.state.btnMessage === 0 ? false : true}>{this.state.btnMessage === 0
                                                ? "Send Message"
                                                : "Sending Message Please Wait.."}</MDBBtn>
                                        </div>
                                        <br />
